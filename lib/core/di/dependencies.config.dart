...
class OtherInjectionModule extends _i1.BaseInjectionModule {
  ...
  void registerDependencies(
    ...
    serviceLocatorHelper
        .registerFactory<_i7.ErrorModelMapper>(() => _i7.ErrorModelMapper());
    serviceLocatorHelper.registerLazySingleton<_i8.GetAllCarsUseCase>(
      () => _i8.GetAllCarsUseCase(serviceLocator.get<_i5.CarsRepository>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i8.GetAllCarsUseCase>(
    ...
    serviceLocatorHelper.registerFactory<_i10.NewCarModelMapper>(
        () => _i10.NewCarModelMapper());
    serviceLocatorHelper.registerFactory<_i11.NewCarOwnerModelMapper>(
        () => _i11.NewCarOwnerModelMapper());
    serviceLocatorHelper.registerLazySingleton<_i12.NewCarOwnerProvider>(
      () => _i12.NewCarOwnerProvider.create(
          serviceLocator.get<_i2.CarAppProvider>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i13.NewCarOwnerRepository>(
        () => _i14.RemoteNewCarOwnersRepository(
              ownerProvider: serviceLocator.get<_i12.NewCarOwnerProvider>(),
              mapper: serviceLocator.get<_i11.NewCarOwnerModelMapper>(),
            ));
    serviceLocatorHelper.registerLazySingleton<_i15.NewCarProvider>(
      () =>
          _i15.NewCarProvider.create(serviceLocator.get<_i2.CarAppProvider>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerFactory<_i16.NewCarResponseModelMapper>(() =>
        _i16.NewCarResponseModelMapper(
            serviceLocator.get<_i7.ErrorModelMapper>()));
    serviceLocatorHelper
    ...
    serviceLocatorHelper.registerLazySingleton<_i21.CarListCubit>(() =>
        _i21.CarListCubit(
            getAllCarsUseCase: serviceLocator.get<_i8.GetAllCarsUseCase>()));
    serviceLocatorHelper.registerLazySingleton<_i22.GetNewCarOwnersUseCase>(
      () => _i22.GetNewCarOwnersUseCase(
          serviceLocator.get<_i13.NewCarOwnerRepository>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i23.GetOwnerUseCase>(
      () => _i23.GetOwnerUseCase(serviceLocator.get<_i19.OwnerRepository>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i24.NewCarOwnerCubit>(
      () => _i24.NewCarOwnerCubit(
          getNewCarOwnersUseCase:
              serviceLocator.get<_i22.GetNewCarOwnersUseCase>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i25.NewCarRepository>(() =>
        _i26.RemoteNewCarRepository(
          newCarProvider: serviceLocator.get<_i15.NewCarProvider>(),
          mapper: serviceLocator.get<_i10.NewCarModelMapper>(),
          responseMapper: serviceLocator.get<_i16.NewCarResponseModelMapper>(),
        ));
    serviceLocatorHelper.registerLazySingleton<_i27.AddNewCarUseCase>(
      () => _i27.AddNewCarUseCase(serviceLocator.get<_i25.NewCarRepository>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i28.CarAddingCubit>(
      () => _i28.CarAddingCubit(
          addNewCarUseCase: serviceLocator.get<_i27.AddNewCarUseCase>()),
      registerFor: {_dev},
    );
    serviceLocatorHelper.registerLazySingleton<_i29.CarDetailCubit>(() =>
        _i29.CarDetailCubit(
            getOwnerUseCase: serviceLocator.get<_i23.GetOwnerUseCase>()));
  }
}
