...
mixin _$CarListState {
  List<Map<String, Object>> get cars => throw _privateConstructorUsedError;
...
abstract class $CarListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Map<String, Object>> cars, bool isLoading});
}
...
class _$_CarListState implements _CarListState {
  const _$_CarListState(
      {required final List<Map<String, Object>> cars, required this.isLoading})
      : _cars = cars;

  final List<Map<String, Object>> _cars;
  @override
  List<Map<String, Object>> get cars {
...
abstract class _CarListState implements CarListState {
  const factory _CarListState(
      {required final List<Map<String, Object>> cars,
